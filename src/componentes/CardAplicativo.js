...
export default class CardAplicativo extends React.Component {
  ...
  render() {
    ...
    const autorizacoes = this.state.autorizacoes;

    return (
      <div
        className={classnames("card-app", { fieldAnimate: !app.status })}
        ...
        <div className="card-main">
          ...
          <div className="card-botoes">
            <button
              ...
              className="btn btn-primary card-botao"
            >
              Editar
            </button>
          </div>
